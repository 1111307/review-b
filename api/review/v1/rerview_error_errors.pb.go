...
func IsDbFaild(err error) bool {
	if err == nil {
		return false
	}
	e := errors.FromError(err)
	return e.Reason == ErrorReason_DB_FAILD.String() && e.Code == 500
}

func ErrorDbFaild(format string, args ...interface{}) *errors.Error {
	return errors.New(500, ErrorReason_DB_FAILD.String(), fmt.Sprintf(format, args...))
}
