...
type Registry_Nacos struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Ip            string                 `protobuf:"bytes,1,opt,name=ip,proto3" json:"ip,omitempty"`      // 127.0.0.1
	Port          uint64                 `protobuf:"varint,2,opt,name=port,proto3" json:"port,omitempty"` // 8848
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_conf_proto_rawDesc = "" +
	...
	"\bRegistry\x120\n" +
	"\x05nacos\x18\x01 \x01(\v2\x1a.kratos.api.Registry.NacosR\x05nacos\x1a+\n" +
	"\x05Nacos\x12\x0e\n" +
	"\x02ip\x18\x01 \x01(\tR\x02ip\x12\x12\n" +
	"\x04port\x18\x02 \x01(\x04R\x04portB\x1dZ\x1breview-b/internal/conf;confb\x06proto3"
